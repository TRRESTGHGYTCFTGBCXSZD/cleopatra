...
Bambisona={
love.graphics.newImage(relativepos..".png")
}
end,
...
Update = function(breaking,animationstore,posx,posy,playerdata)
end,
Draw = function(x,y,color,size,breaking,animationstore,posx,posy,playerdata)
end,
}